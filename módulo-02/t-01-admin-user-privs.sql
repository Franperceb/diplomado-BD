...
--@Descripción: Ejercicio 04 -módulo 02 . Ejercicio de tarea respecto a admin privs, user profiles.
...
prompt 3. Creando User Profile worker_profile;
...
connect sys/sysdba as ssydba
grant insert on jfpc01.amigo to jfpc_worker01

prompt  4. Inserando 3 registros en tabla jfpc01.amigo como jfpc_worker01
insert into jfpc01.amigo(2,"Jorge02");
insert into jfpc01.amigo(3,"Jorge03");
insert into jfpc01.amigo(4,"Jorge04");
...
insert into jfpc01.amigo(4,"Jorge05");
...
grant select on jfpc01.amigo to jfpc_slave;
grant delete on jfpc01.amigo to jfpc_slave;
